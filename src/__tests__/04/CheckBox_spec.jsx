...
describe('<Checkbox>', () =>{
    ...
    it('displays error Message', () =>{
        ...
        const errorHtml = shallow(<Checkbox name="name" errorMessage={errorMessage}>테스트</Checkbox>).dive().find('span').html();
    ...
    it('calls back onChange on clicked', () =>{
        ...
        const input = shallow(<Checkbox name="test_name" onChange={changeStub}>테스트</Checkbox>).dive().find('input');
